...
- 광고 단가가 높으면서도 '일반 개인'이 클릭할 세부 키워드를 노린다.
- 특히 광고 단가(CPC)가 높은 세부 주제를 우대한다: 대출·신용/한도·보험·카드·세금/절세·연말정산·청약·연금·재테크·투자,
  그리고 건강검진·보험·영양제·치과/시술 비용, 자동차보험·법률/상담 비용 등 '돈이 걸린' 주제. (단, 일반인이 실제로 검색하는 각도로)
